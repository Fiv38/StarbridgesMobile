...
import id.co.indocyber.android.starbridges.model.ListEmployee.ReturnValue;
...
public class ShiftExchangeDetailActivity extends AppCompatActivity {
    ...
    List<ReturnValue> lstEmployee;
    List<id.co.indocyber.android.starbridges.model.ListShift.ReturnValue> lstShift;
    ...
    id.co.indocyber.android.starbridges.model.EditShiftExchange.ReturnValue editShiftChange;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmployeeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ReturnValue employee = (ReturnValue) mEmployeeSpinner.getItemAtPosition(i);
        ...
        mShiftSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                id.co.indocyber.android.starbridges.model.ListShift.ReturnValue shift = (id.co.indocyber.android.starbridges.model.ListShift.ReturnValue) mShiftSpinner.getItemAtPosition(i);
                //if (shift != null) {
                shiftID = shift.getID();
                //}
            }
        ...
        apiInterface.editShiftExchange(id).enqueue(new Callback<EditShiftExchange>() {
            ...
            public void onResponse(Call<EditShiftExchange> call, Response<EditShiftExchange> response) {
                ...
                if (response.body().getIsSucceed()) {
                    ...
                    if (empID != null) {
                        int counterE = 0;
                        for (ReturnValue employee : lstEmployee) {
                    ...
                    if (shiftID != null) {
                        int counterL = 0;
                        for (id.co.indocyber.android.starbridges.model.ListShift.ReturnValue shift : lstShift) {
        ...
        apiInterface.getListShiftEmployee().enqueue(new Callback<ListEmployee>() {
            ...
            public void onResponse(Call<ListEmployee> call, Response<ListEmployee> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    List<ReturnValue> EmpItems = response.body().getReturnValue();
                    if (EmpItems != null) {
                    ...
                    ArrayAdapter<ReturnValue> adapter = new ArrayAdapter<ReturnValue>(ShiftExchangeDetailActivity.this,
    ...
    public void initSpinnerShift() {
        ...
        id.co.indocyber.android.starbridges.model.ListShift.ReturnValue returnValue = new id.co.indocyber.android.starbridges.model.ListShift.ReturnValue();
        returnValue.setID("");
        returnValue.setName("");
        ...
        apiInterface.getListShift().enqueue(new Callback<ListShift>() {
            ...
            public void onResponse(Call<ListShift> call, Response<ListShift> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    List<id.co.indocyber.android.starbridges.model.ListShift.ReturnValue> ShiftItems = response.body().getReturnValue();
                    if (ShiftItems != null) {
                    ...
                    ArrayAdapter<id.co.indocyber.android.starbridges.model.ListShift.ReturnValue> adapter = new ArrayAdapter<id.co.indocyber.android.starbridges.model.ListShift.ReturnValue>(ShiftExchangeDetailActivity.this,

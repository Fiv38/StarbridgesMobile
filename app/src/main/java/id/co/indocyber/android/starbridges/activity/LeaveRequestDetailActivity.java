...
import id.co.indocyber.android.starbridges.model.editleaverequest.ReturnValue;
...
public class LeaveRequestDetailActivity extends AppCompatActivity {
    ...
    id.co.indocyber.android.starbridges.model.requestconfirmation.ReturnValue requestConfirmation;

    // get data from edit leave request
    ReturnValue editLeaveRequest;

    // get data from spinner balance type
    List<id.co.indocyber.android.starbridges.model.balanceType.ReturnValue> LocItems1;
    List<id.co.indocyber.android.starbridges.model.balanceType.ReturnValue> listReturnValue1;

    // get data from spinner request type
    List<id.co.indocyber.android.starbridges.model.requesttype.ReturnValue> LocItems;
    List<id.co.indocyber.android.starbridges.model.requesttype.ReturnValue> listReturnValue;
...
//                    requestConfirmation();
        ...
        spinnerRequestType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                final id.co.indocyber.android.starbridges.model.requesttype.ReturnValue returnValue = (id.co.indocyber.android.starbridges.model.requesttype.ReturnValue) spinnerRequestType.getItemAtPosition(i);
...
//                defaultLabelEndDate(leaveRequestRuleID);
        ...
        spinnerBalanceType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                final id.co.indocyber.android.starbridges.model.balanceType.ReturnValue returnValue1 = (id.co.indocyber.android.starbridges.model.balanceType.ReturnValue) spinnerBalanceType.getItemAtPosition(i);
...
//        }
    ...
    public void initSpinnerBalanceType() {
        ...
        id.co.indocyber.android.starbridges.model.balanceType.ReturnValue returnValue1 = new id.co.indocyber.android.starbridges.model.balanceType.ReturnValue();
        ...
        call3.enqueue(new Callback<BalanceType>() {
            ...
            public void onResponse(Call<BalanceType> call, Response<BalanceType> response) {
                ...
                if (data != null) {
                    ...
                    ArrayAdapter<id.co.indocyber.android.starbridges.model.balanceType.ReturnValue> adapter = new ArrayAdapter<id.co.indocyber.android.starbridges.model.balanceType.ReturnValue>(LeaveRequestDetailActivity.this,
    ...
    public void initSpinnerRequestType() {
        ...
        id.co.indocyber.android.starbridges.model.requesttype.ReturnValue returnValue = new id.co.indocyber.android.starbridges.model.requesttype.ReturnValue();
        returnValue.setID(0);
        returnValue.setName("");
        ...
        call3.enqueue(new Callback<RequestType>() {
            ...
            public void onResponse(Call<RequestType> call, Response<RequestType> response) {
                ...
                if (data != null) {
                    ...
                    ArrayAdapter<id.co.indocyber.android.starbridges.model.requesttype.ReturnValue> adapter = new ArrayAdapter<id.co.indocyber.android.starbridges.model.requesttype.ReturnValue>(LeaveRequestDetailActivity.this,
...
//            }
    ...
    public void setupSpinner() {
        ...
        if (idRequestType > 0) {
            for (id.co.indocyber.android.starbridges.model.requesttype.ReturnValue x : listReturnValue) {
    ...
    public void setupSpinnerBalance() {
        ...
        if (balanceUID != "") {
            for (id.co.indocyber.android.starbridges.model.balanceType.ReturnValue x : listReturnValue1) {
...
//                    selectedImage2.createScaledBitmap(selectedImage, newWidth, newHeight, false);
                    ...
                    attachmentFile = encodeImage(selectedImage2,100);

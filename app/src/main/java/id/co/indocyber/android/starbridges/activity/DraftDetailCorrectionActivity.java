...
import id.co.indocyber.android.starbridges.model.CorrectionDetail.ReturnValue;
...
public class DraftDetailCorrectionActivity extends AppCompatActivity {
    ...
    List<id.co.indocyber.android.starbridges.model.OLocation.ReturnValue> locItems;
    List<id.co.indocyber.android.starbridges.model.OLocation.ReturnValue> listReturnValue;
...
//        spnLocationCDraftDetails.setClickable(true);
        ...
        spnLocationCDraftDetails.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                final id.co.indocyber.android.starbridges.model.OLocation.ReturnValue returnValue1=(id.co.indocyber.android.starbridges.model.OLocation.ReturnValue)spnLocationCDraftDetails.getItemAtPosition(i);
        ...
        apiInterface.getLocation().enqueue(new Callback<OLocation>() {
            ...
            public void onResponse(Call<OLocation> call, Response<OLocation> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ArrayAdapter<id.co.indocyber.android.starbridges.model.OLocation.ReturnValue> adapter = new ArrayAdapter<id.co.indocyber.android.starbridges.model.OLocation.ReturnValue>(DraftDetailCorrectionActivity.this,
            ...
            public void onFailure(Call<OLocation> call, Throwable t) {
                Toast.makeText(DraftDetailCorrectionActivity.this, getString(R.string.error_connection), Toast.LENGTH_SHORT).show();
    ...
    public void setupSpinner()
    {
        ...
        if(locationId!=null)
        {
            for(id.co.indocyber.android.starbridges.model.OLocation.ReturnValue x: listReturnValue)
            {

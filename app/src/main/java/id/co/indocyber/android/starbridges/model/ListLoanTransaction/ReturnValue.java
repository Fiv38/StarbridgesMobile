...
package id.co.indocyber.android.starbridges.model.ListLoanTransaction;
...
public class ReturnValue implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -1280267309293877034L;
     ...
     */
    public ReturnValue(String iD, String decisionNumber, String transactionType, String policy, String startDate, Integer creditAmount, Object installment, Integer amount, String loanBalanceID, Boolean fullAccess, List<Object> exclusionFields, String accessibilityAttribute) {
        super();
        this.iD = iD;

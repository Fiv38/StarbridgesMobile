...
package id.co.indocyber.android.starbridges.model.ListDraftLeaveCancelation;
...
public class ListDraftLeaveCancelation implements Serializable, Parcelable
{
    ...
    public final static Creator<ListDraftLeaveCancelation> CREATOR = new Creator<ListDraftLeaveCancelation>() {

...
public class ReturnValue implements Serializable, Parcelable
{
    ...
    @Expose
    private Object leaveRequestTransactionID;
    ...
    ;
    private final static long serialVersionUID = 7885462552887072705L;
    ...
    protected ReturnValue(Parcel in) {
        ...
        this.leaveRequestTransactionID = ((Object) in.readValue((Object.class.getClassLoader())));
     ...
     * @param requestorID
     */
    public ReturnValue(String iD, String employeeID, int requestorID, Object leaveRequestDecisionNumber, Object leaveRequestTransactionID, Object leaveRequestType, int leaveRequestRuleID, String requestDate, String leaveFrom, String leaveTo, String cancelFrom, String cancelTo, String notes, String attachmentFile, int attachmentID, int additionalBalance, int transactionStatusID, int totalUnitReduce, String transactionStatusSaveOrSubmit, boolean fullAccess, List<String> exclusionFields, String accessibilityAttribute) {
        super();
        this.iD = iD;
    ...
    public Object getLeaveRequestTransactionID() {
        return leaveRequestTransactionID;
    }

    public void setLeaveRequestTransactionID(Object leaveRequestTransactionID) {
        this.leaveRequestTransactionID = leaveRequestTransactionID;
    }

    public ReturnValue withLeaveRequestTransactionID(Object leaveRequestTransactionID) {
        this.leaveRequestTransactionID = leaveRequestTransactionID;
        return this;
    }

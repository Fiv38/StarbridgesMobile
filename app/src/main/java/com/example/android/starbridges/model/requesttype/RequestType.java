...
public class RequestType implements Serializable, Parcelable
{
    ...
    public final static Creator<RequestType> CREATOR = new Creator<RequestType>() {
    ...
    ;
    private final static long serialVersionUID = 8822783676982881946L;

    protected RequestType(Parcel in) {
        this.customField = ((CustomField) in.readValue((CustomField.class.getClassLoader())));
        in.readList(this.returnValue, (com.example.android.starbridges.model.requesttype.ReturnValue.class.getClassLoader()));
     ...
     * @param returnValue
     */
    public RequestType(CustomField customField, List<ReturnValue> returnValue, Boolean isSucceed, String message) {
        super();

...
public class DraftCorrectionAdapter extends RecyclerView.Adapter<DraftCorrectionAdapter.ViewHolder> {
    ...
    private List<com.example.android.starbridges.model.ListDraftCorrection.ReturnValue> corrections;

    JSONArray jsonArrayIdSelected = new JSONArray();

    List<String> lstIdSelected= new ArrayList<>();

    public DraftCorrectionAdapter(Context context, List<com.example.android.starbridges.model.ListDraftCorrection.ReturnValue> corrections) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final com.example.android.starbridges.model.ListDraftCorrection.ReturnValue value = corrections.get(position);

...
import com.example.android.starbridges.adapter.ListDraftLeaveRequestAdapter2;
...
//                                idSelected= SharedPreferenceUtils.getSetting(DraftCorrectionListActivity.this, "lstIdSelected", "");
                                            ...
                                            for (int i2 = (selected.size() - 1); i2 >= 0; i2--) {
                                                if (selected.valueAt(i2)) {
                                                    com.example.android.starbridges.model.listdraftleaverequest.ReturnValue selecteditem = adapter2

...
package com.example.android.starbridges.model.leaverequest;
...
public class LeaveRequest implements Serializable, Parcelable
{
    ...
    protected LeaveRequest(Parcel in) {
        ...
        in.readList(this.returnValue, (com.example.android.starbridges.model.leaverequest.ReturnValue.class.getClassLoader()));

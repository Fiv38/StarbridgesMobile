...
package com.example.android.starbridges.model.history;
...
public class History implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -8496145820496721560L;

    protected History(Parcel in) {
        this.customField = ((CustomField) in.readValue((CustomField.class.getClassLoader())));
        in.readList(this.returnValue, (com.example.android.starbridges.model.history.ReturnValue.class.getClassLoader()));
     ...
     * @param returnValue
     */
    public History(CustomField customField, List<ReturnValue> returnValue, Boolean isSucceed, String message) {
        super();
